...
export const FALLBACK_VERSIONS = {
  cheatsheet: {
    "FortiGate": ["8.0.0", "7.6.6", "7.6.5", "7.6.4", "7.6.3", "7.6.2", "7.6.1", "7.6.0", "7.4.7", "7.4.6", "7.4.5", "7.4.4", "7.4.3", "7.4.2", "7.4.1", "7.4.0", "7.2.11", "7.2.10", "7.2.9", "7.2.8", "7.2.7", "7.0.17", "7.0.16", "7.0.15", "7.0.14", "6.4.15", "6.4.14"],
  ...
  diffBranches: ["8.0.x", "7.6.x", "7.4.x", "7.2.x", "7.0.x", "6.4.x", "6.2.x"],
};
